...
## Welcome to the documentation for **AIMMS** 
...
- For ComfyUI workflows, research notes, and free resources, visit - [**Research & Workflows**](https://markdkberry.com/workflows/research/)
...
- [License Delivery](https://markdkberry.com/aimms-docs/license-delivery/)

- [Licensing FAQs](https://markdkberry.com/aimms-docs/faq/)

- [Terms of Service](https://markdkberry.com/aimms-docs/terms/)

- [Privacy Policy](https://markdkberry.com/aimms-docs/privacy/)
...
- Bug reports, issues, and feature suggestions can be submitted via [**GitHub Issues**](https://github.com/AI-Making-Movies/aimms-docs/issues)
  ...
  - Issues are reviewed and addressed **at the developer’s discretion**
  - Responses and fixes are provided **when time permits**
  - Submitting an issue does **not** guarantee a response or resolution

This approach allows AIMMS to remain a focused, independently developed tool rather than a subscription-based service.
