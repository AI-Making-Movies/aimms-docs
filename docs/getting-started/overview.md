...
**AIMMS Version 1.0.x (StorM)** is a passive storyboard management system. Future versions will integrate with AI systems using API and batch workflow processing. Note: Version 1.x licenses include all future 1.x updates, but versions 2.x onward will be paid upgrades.
