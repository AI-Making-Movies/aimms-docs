...
- **Images** (Ctrl+2): View and manage base images
- **Videos** (Ctrl+3): View and manage final videos
...
- **Routing** (Ctrl+8): Advanced workflow routing
...
2. **Add New Shot**
   ...
   - Fill in the shot details:
     - **Order Number**: 1 (sequence position)
     - **Shot Name**: `INT_OFFICE_DAY_001` (Interior Office Day Shot 1)
     - **Section**: `Act 1` (group shots by scenes)
